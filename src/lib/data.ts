...
export const adminPermissions: UserPermissions = {
  ...
  users: { view: true, add: true, edit: true, delete: true, confirm: true },
  ...
  settings: { view: true, add: true, edit: true, delete: true, confirm: true },
  reports: { view: true, add: true, edit: true, delete: true, confirm: true },
};
